...
# balance=1000 exposure=2.0 entry_set=0005_001_005 ladder=payback_tp95
...
_BIG_SWAN_LEVELS = (0.005, 0.01, 0.05)
...
BIG_SWAN_MODE = ModeConfig(
    ...
    tp_levels=(
        TPLevel(progress=0.50, fraction=0.04),
        TPLevel(progress=0.95, fraction=0.96),
    ),
