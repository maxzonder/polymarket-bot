...
class BigSwanOptimizerTests(unittest.TestCase):
    ...
    def test_validate_ladder_requires_full_allocation(self) -> None:
        with self.assertRaises(ValueError):
            validate_ladder((TPLevel(progress=0.10, fraction=0.10),), moonbag_fraction=0.70)

        validate_ladder((TPLevel(progress=0.10, fraction=0.10),), moonbag_fraction=0.90)
